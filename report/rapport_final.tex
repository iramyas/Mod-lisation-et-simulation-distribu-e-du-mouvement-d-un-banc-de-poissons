...
2 & 1317.285 & 688.455  & 1.91x \\
4 & 1456.537 & 348.516  & 4.18x \\
\hline
\end{tabular}
\label{tab:perf_mpi}
\end{table}

Le résultat le plus important est obtenu à 4 processus : le temps MPI tombe à 348.516 ms, soit 4.18x plus rapide que la référence séquentielle mesurée dans le même scénario. Le cas à 1 processus reste légèrement plus lent que le séquentiel pur, ce qui correspond au coût d'infrastructure MPI.
